...
function leftTeamB() {
        if (leftPressed && centerHorizontalPositionB > canvas.width/2 ) {
...
function rightTeamB() {
        if (rightPressed && leftDefenseHorizontalPositionB < goalieHorizontalPositionB - playerWidth) {
        leftDefenseHorizontalPositionB += 5;
        rightDefenseHorizontalPositionB += 5;
        leftWingHorizontalPositionB += 7;
        rightWingHorizontalPositionB += 7;
...
function upTeamB() {
        if (upPressed && rightWingVerticalPositionB > 0){
...
function downTeamB() {
        if (downPressed && leftWingVerticalPositionB < canvas.height - playerHeight){
        leftDefenseVerticalPositionB += 7;
        rightDefenseVerticalPositionB += 7;
        leftWingVerticalPositionB += 5;
        rightWingVerticalPositionB += 5;
