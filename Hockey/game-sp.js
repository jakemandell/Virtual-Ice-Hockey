//Created by Jake Mandell -  Jul-Aug, 2015
...
function leftTeamA() {
    if (aPressed && leftDefenseHorizontalPositionA > goalieHorizontalPositionA + goalieWidth) {
        leftDefenseHorizontalPositionA -= 5;
        rightDefenseHorizontalPositionA -= 5;
        leftWingHorizontalPositionA -= 7;
        rightWingHorizontalPositionA -= 7;
        centerHorizontalPositionA -= 7;
    }
}

function rightTeamA() {
        if (dPressed && centerHorizontalPositionA < canvas.width/2 - playerWidth) {
        leftDefenseHorizontalPositionA += 5;
        rightDefenseHorizontalPositionA += 5;
        leftWingHorizontalPositionA += 7;
        rightWingHorizontalPositionA += 7;
...
function upTeamA() {
        if (wPressed && leftWingVerticalPositionA > 0){
        leftDefenseVerticalPositionA -= 7;
        rightDefenseVerticalPositionA -= 7;
        leftWingVerticalPositionA -= 5;
        rightWingVerticalPositionA -= 5;
        centerVerticalPositionA -= 5;
        goalieVerticalPositionA -= 1.5;
    }
}

function downTeamA() {
        if (sPressed && rightWingVerticalPositionA < canvas.height - playerHeight){
        leftDefenseVerticalPositionA += 7;
        rightDefenseVerticalPositionA += 7;
        leftWingVerticalPositionA += 5;
        rightWingVerticalPositionA += 5;
...
function leftTeamB() {
        if (x + 2*dx < canvas.width/2 && centerHorizontalPositionB > canvas.width/2 ) {
        leftDefenseHorizontalPositionB -= 5;
        rightDefenseHorizontalPositionB -= 5;
        leftWingHorizontalPositionB -= 7;
        rightWingHorizontalPositionB -= 7;
        centerHorizontalPositionB -= 7;
    }
}

function rightTeamB() {
        if (x + 2*dx > canvas.width/2 && leftDefenseHorizontalPositionB < goalieHorizontalPositionB - playerWidth) {
        leftDefenseHorizontalPositionB += 5;
        rightDefenseHorizontalPositionB += 5;
        leftWingHorizontalPositionB += 7;
        rightWingHorizontalPositionB += 7;
...
function upTeamB() {
        if (y + 2*dy < canvas.height/2 && rightWingVerticalPositionB > 0){
        leftDefenseVerticalPositionB -= 7;
        rightDefenseVerticalPositionB -= 7;
        leftWingVerticalPositionB -= 5;
        rightWingVerticalPositionB -= 5;
        centerVerticalPositionB -= 5;
        goalieVerticalPositionB -= 1.5;
    }
}

function downTeamB() {
        if (y + 2*dy > canvas.height/2 && leftWingVerticalPositionB < canvas.height - playerHeight){
        leftDefenseVerticalPositionB += 7;
        rightDefenseVerticalPositionB += 7;
        leftWingVerticalPositionB += 5;
        rightWingVerticalPositionB += 5;
